...
SECRET_KEY = 'rp&48@d18oz45*y%kug8@%+#kne4mr$v4)k(^-fqo_w7vfn%9i'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['seriesDjangoProject/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT=os.path.join(BASE_DIR,'seriesDjangoProject','static')
STATIC_URL = '/static/'
STATICFILES_DIRS = (
...
EMAIL_PORT = 587
EMAIL_HOST_USER = '1970annasmith@gmail.com'
EMAIL_HOST_PASSWORD = 'motdepassepassword'
EMAIL_USE_TLS = True